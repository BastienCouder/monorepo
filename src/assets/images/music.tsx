...
const MusicIcon: React.FC<MusicIconProps> = ({ color }) => {
  return (
    <svg
      fill={color}
      version="1.1"
      ...
      width="100%"
      height="100%"
      viewBox="0 0 322.199 322.199"
    >
      <g>
        <path
          d="M97.173,322.156c35.754,0.874,67.271-11.577,84.481-30.805c6.111-6.845,10.074-14.932,10.836-16.527
