...
interface PicturesIconProps {
  color: string;
}

const PicturesIcon: React.FC<PicturesIconProps> = ({ color }) => {
  return (
    <svg
      fill={color}
      width="100%"
